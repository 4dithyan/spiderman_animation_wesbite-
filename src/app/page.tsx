      ...
      <main ref={mainRef} className="relative bg-background transition-colors duration-1000">
        ...
        >
          <div className="text-center max-w-6xl">
            ...
            <SplitText 
              text="THE SPIDER" 
              className="font-mono text-[clamp(2.5rem,15vw,15rem)] font-bold leading-[0.8] tracking-tighter uppercase whitespace-nowrap"
            />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-32 w-full max-w-7xl px-20">
            <div className="reveal-text space-y-12">
              <div className="space-y-4">
                ...
                <SplitText text="RAIMI PROTOCOL" className="font-mono text-5xl md:text-7xl font-bold tracking-tighter uppercase" />
              </div>
        ...
        >
          <div className="flex flex-col items-center text-center max-w-5xl">
            ...
            <SplitText text="AMAZING NODES" className="font-mono text-6xl md:text-8xl font-bold tracking-tighter uppercase mb-16" />
            <div className="reveal-text grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 w-full">
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-32 w-full max-w-7xl px-8 md:px-20">
            <div className="reveal-text flex flex-col justify-center items-center md:items-start text-center md:text-left">
              <SplitText text="MCU INTEGRATION" className="font-mono text-6xl md:text-8xl font-bold tracking-tighter uppercase leading-[0.8] mb-12" />
